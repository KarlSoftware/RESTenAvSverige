  ...
  render() {
    ...
    return (
      <div className={styles.main}>
        <svg onBlur={this.props.clearLan} tabIndex="0" className={styles.svg} xmlns="http://www.w3.org/2000/svg" viewBox={this.props.viewBox || "-8449.69 -8449.69 692875 1.57668e+006"} >
